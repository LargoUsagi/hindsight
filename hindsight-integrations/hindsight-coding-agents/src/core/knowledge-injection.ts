...
const TOOL_GUIDE =
  ...
  "- hindsight_capture_initiative(title, summary) — when you START (or substantially advance) a MAJOR new feature, " +
  "initiative, or enhancement, record it so it becomes a tracked page future sessions can pick up. NOT for routine " +
  "bug fixes, small tweaks, or chores.\n" +
